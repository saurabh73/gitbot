...
- `message_im.js`
- `auth.js`
- `commands/message_im.js`
- `events/message_im.js`
- `actions/message_im.js`

We'll go through these in the order listed here.

## Function: `functions/message_im.js`
...
Any time a function has the filename `message_im.js`, the enclosing folder is
...
## Function: `functions/commands/message_im.js`
...
## Function: `functions/events/message_im.js`
...
which can be placed in `functions/events/TYPE.js` or `functions/events/TYPE/message_im.js`
as these are functionally equivalent. If there is a subtype involved,
`functions/events/TYPE/SUBTYPE.js` or `functions/events/TYPE/SUBTYPE/message_im.js`
will be invoked.

By default your `functions/events/message/message_im.js` should look like this:
...
## Function: `functions/actions/message_im.js`
